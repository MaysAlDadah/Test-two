...
Route::view('/secretpage', 'secretpage')->name('secretpage')->middleware('verified');


//Route::middleware('verified')->view('/secretpage', 'secretpage')->name('secretpage');

// Task: this "/verysecretpage" URL should ask user for verifying their password once again
// You need to add some middleware here


Route::view('/verysecretpage', 'verysecretpage')->name('verysecretpage')->middleware('password.confirm');;
